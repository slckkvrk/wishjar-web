  ...
  return (
    <main className="min-h-screen bg-wj-cream px-6 py-12 text-wj-text">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mb-2 text-4xl font-bold text-wj-text">Privacy Policy</h1>
        <p className="mb-2 text-sm text-wj-muted">
          Last updated: June 27, 2026
        </p>
        <p className="mb-10 text-sm text-wj-muted">
        ...
        <section className="space-y-10 text-sm leading-7 text-wj-text">
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">1. Data Controller</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">2. What Data We Collect</h2>
            ...
            <p className="mt-3 text-wj-muted">
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">3. Why We Process Your Data</h2>
            <table className="w-full border-collapse text-xs">
              <thead>
                <tr className="bg-wj-cream">
              ...
              <tbody>
                {[
                  ...
                  <tr key={purpose}>
                    ...
                    <td className="border p-3 text-wj-muted">{gdpr}</td>
                    <td className="border p-3 text-wj-muted">{kvkk}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">4. Data Transfers Outside Turkey / EEA</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">5. Data Retention</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">6. Your Rights</h2>
            <p className="mb-3">
            ...
            <p className="mt-3 text-wj-muted">
              ...
              <a
                ...
                className="text-wj-plum underline"
              >
                kvkk.gov.tr
              </a>
              .
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">7. Security</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">8. Cookies</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">9. Children</h2>
            <p>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-wj-text">10. Changes to This Policy</h2>
            <p>
